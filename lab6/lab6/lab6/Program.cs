...
namespace LAB6
{
    class Program
    {
        static void Main()
        {
            string message = "101110010101100110011110010110110101101111101010101010101010101010101010101010101010101010100100011";
        ...
        {
            string message1 = "101110010101100110011110010110110101101111101010101010101010101010101010101010101010101010100100011";
            ...
            GenerateErrorPackets(matrix, 4);
            GenerateErrorPackets(matrix, 8);
